...
export function WordReview({ wordId, axis, isCurator, onAxisChange, onDecided }: WordReviewProps) {
  ...
  return (
    <>
      ...
      {axis === 'entry' ? <EntryReview wordId={wordId} isCurator={isCurator} onDecided={handleDecided} /> : null}
