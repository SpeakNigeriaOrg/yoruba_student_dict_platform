...
//
// One shared row of per-axis status badges (entry/etymology/audio) - used
// on both AllWordsList (browse) and AssignmentsList (my assignments), so a
// curator sees the same status at a glance in either place, not a bespoke
// rendering per screen. Previously only AllWordsList had this, and it
// predated the audio axis entirely (no badge for it at all).
